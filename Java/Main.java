 ...
 * Main.java
 * 
 * This driver program reads the input files (generated by DataGenerator.java) for three case types:
 * AVERAGE, BEST, and WORST. For each case type and each input size (100, 1000, 5000, 10000),
 ...
 * 
 * The results are written to a CSV file ("results.csv") in the same folder as Main.java.
 ...
 * 				
 * 				
 * (Two blank lines separate blocks.)
 * 
...
public class Main {
    ...
    // CSV file name; by using a relative path, the file will be created in the same folder as Main.java.
    public static final String CSV_FILE = "results.csv";
    ...
    public static String generateCSVBlock(String caseType, String timestamp, ArrayList<String> fileList) {
        ...
        for (String fileName : fileList) {
            ...
            if (items != null) {
                ...
                double durationMillis = (endTime - startTime) / 1e6; // Convert to ms.
    ...
    /**
     * Reads integers (item sizes) from a text file.
    ...
    /**
     * Appends the given CSV block (a multiline string) to the CSV file.
     * The CSV file is created (or appended to) in the same folder as Main.java.
     *
